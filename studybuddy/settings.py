...
TEMPLATE_DIRS = [os.path.join(BASE_DIR, 'forum/templates/forum')]

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.10/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'c8og%b&365stlc+xr_t9!=*cl*vo6zzh4ng(7@d3mo1-#_lgsr'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'forum/templates/forum')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
